...
<template>
  <div class="min-h-screen bg-zinc-950 flex flex-col items-center justify-center p-6 text-center">
    <div class="space-y-8 max-w-md w-full animate-in fade-in zoom-in-95 duration-700">
      ...
      <div class="relative w-32 h-32 mx-auto">
        ...
        <div class="relative w-full h-full bg-zinc-900 border border-zinc-800 rounded-full flex items-center justify-center shadow-2xl">
          ...
          <svg v-else xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-red-500"><circle cx="12" cy="12" r="10"/><line x1="15" y1="9" x2="9" y2="15"/><line x1="9" y1="9" x2="15" y2="15"/></svg>
        </div>
      </div>
      ...
      <!-- Loading Bar -->
      <div v-if="!errorMsg" class="w-full bg-zinc-900 rounded-full h-1 overflow-hidden">
        <div class="bg-white h-full rounded-full w-1/3 animate-[loading_2s_ease-in-out_infinite]"></div>
      </div>
